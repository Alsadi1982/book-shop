...
public class CatalogServiceClient {
    ...
    public boolean checkAndReserveStock(Long bookId, Integer quantity) {
        try {
            ...
            logger.severe("Failed to reserve stock for book " + bookId + ": " + e.getMessage());
            return false;
        }
    }
    ...
    public boolean returnStock(Long bookId, Integer quantity) {
        try {
            ...
            logger.warning("Book not found when returning stock: " + bookId);
            return false;
        } catch (Exception e) {
            logger.severe("Failed to return stock for book " + bookId + ": " + e.getMessage());
            return false;
        }
    }
    ...
    public Map<String, Object> getUser(Long userId) {
        try {
            ...
            logger.severe("User service unavailable: " + e.getMessage());
